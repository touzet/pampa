...
def main():
    ...
    group3.add_argument("-p", dest="peptide_table",nargs='+', help="Peptide table (TSV file)", type=str)
    ...
    if args.modules == "assign":
        main_assign.main(args.spectra, args.taxonomy, args.peptide_table, args.fasta, args.directory, args.limit, args.error, args.neighbour, args.all, args.output, False, False)  
