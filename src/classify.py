...
def main(command_line, spectra, taxonomy, peptide_table, fasta, fasta_dir, limit, deamidation, error, neighbour, allsolutions, output, mammals, birds, web, config_file):
    ...
    try:
        ...
        (spectra, taxonomy, peptide_table, fasta, fasta_dir, limit, deamidation, error, neighbour, allsolutions, config_file) = params_checker.check_and_update_parameters_classify(spectra, taxonomy, peptide_table, fasta, fasta_dir, limit, deamidation, error, neighbour, allsolutions, mammals, birds, config_file)
        ...
        if peptide_table :
            ...
            set_of_markers=ta.supplement_taxonomic_information(set_of_markers, full_taxonomy) # To check: see supplement
        ...
        assignment.assign_all_spectra(list_of_spectra, set_of_markers, error, taxonomy, final_taxonomy, neighbour, allsolutions, config_nb_of_peaks, config_markers, output, detail, jsonf)
