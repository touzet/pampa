...
def add_digestion_status(set_of_incomplete_markers, set_of_sequences):
    set_of_seqid={m.seqid() for m in set_of_incomplete_markers if "Digestion" not in m.field}
